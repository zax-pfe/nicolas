...
export default function Index() {
  ...
  useEffect(() => {
    const fetchProject = async () => {
      try {
        const data = await client.fetch(ARMERMAID_PROJECT_QUERY);
  ...
  return (
    <Inner>
      ...
      <ProjectPage
        ...
        // placeHolderImage={projectsDescription.armermaid.videoPlaceHolder}
        placeHolderImage={project.thumbnailURL}
        projectsDescription={project.projectInfos}
        // video={projectsDescription.armermaid.video}
